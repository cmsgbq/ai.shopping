...
if __name__ == '__main__':  
    ...
    train_30_4 = feature_io.read_feature(path1+'train_f_30_4.csv')
    train_30_4 = train_30_4[:, -4:]
    train_id = feature_io.read_id_int(path1+'train_id.csv')
    train_30_4 = np.concatenate((np.array(train_id), train_30_4), axis=1)
    train_30_4 = pd.DataFrame(train_30_4)
    train_30_4 = train_30_4.rename(columns={0:'USRID', 1:'balabala', 2:'ba2labala', 3:'balabal2a', 4:'b4alabala'})
    ...
    all_train = pd.merge(all_train,train_30_4,on=['USRID'],how='left')
    print('**********************')
    ...
    test_30_4 = feature_io.read_feature(path1+'test_f_30_4.csv')
    test_30_4 = test_30_4[:, -4:]
    test_id = feature_io.read_id_int(path1+'test_id.csv')
    test_30_4 = np.concatenate((np.array(test_id), test_30_4), axis=1)
    test_30_4 = pd.DataFrame(test_30_4)
    test_30_4 = test_30_4.rename(columns={0:'USRID', 1:'balabala', 2:'ba2labala', 3:'balabal2a', 4:'b4alabala'})
    ...
    test_set = pd.merge(test_set,test_30_4,on=['USRID'],how='left')
    print('**********************')
...
#auc value: 0.8434038974430462
#validate result: 0.858367113959404