...
def get_data():
    ...
    train_feartue = pd.read_csv('../../data/for_add_feature/final_feature0.csv', header = None, index_col = None).as_matrix()
...
def build_loadfile():
    ...
    #feature
    submite_x_test_feature = pd.read_csv('../../data/for_add_feature/final_feature0_test.csv', header = None, index_col = None).as_matrix()
